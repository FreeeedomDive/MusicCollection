...
using MusicCollection.MusicService.Clients;
...
public class QueuesService : IQueuesService
{
    public QueuesService(
        ...
        IUserServiceClient musicServiceClient
    )
    {
    ...
    public async Task CreateQueueAsync(Guid userId, Guid contextId)
    {
        ...
        var userSettings = await musicServiceClient.ReadOrCreateUserSettingsAsync(userId);
    ...
    public async Task UpdateWithShuffleAsync(Guid userId, bool shuffle)
    {
        ...
        await musicServiceClient.UpdateAsync(userId, userSettings);
    ...
    private readonly IUserServiceClient musicServiceClient;
}